      ...
      <section className="flex flex-col items-start justify-between gap-x-12 xl:flex-row xl:items-center xl:justify-center">
        <div className="max-w-2xl duration-700 animate-in slide-in-from-top-full lg:max-w-2xl">
          ...
          <p className="text-base leading-relaxed text-foreground/60">
            ...
            passionate about learning new technologies and building impactful solutions that make a difference in the digital world.
          </p>
        ...
        <div className="grid grid-cols-1 gap-x-12 gap-y-10 lg:grid-cols-2">
          ...
          <div className="relative flex max-w-2xl items-start gap-x-4 before:absolute before:bottom-0 before:left-9 before:top-[5rem] before:h-[calc(100%-70px)] before:w-[1px] before:bg-muted lg:gap-x-6">
            ...
            <div className="flex flex-col items-start">
              ...
              <p><a href="https://humraahstore.com" target="_blank" rel="noreferrer noopener">Humraah Store</a></p>
              ...
              <p className="my-4 tracking-tight text-foreground/60 hover:text-foreground/75">
              Developed the website using WordPress, managed operations, and led business development efforts to drive growth.
              </p>
            </div>
          </div>
        </div>
